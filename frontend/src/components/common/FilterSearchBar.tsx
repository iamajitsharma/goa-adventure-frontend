  ...
  return (
    <div
      className={`flex flex-col lg:flex-row ${
        !showSortOption ? "h-[60px] rounded-full" : "rounded-md h-[150px]"
      } lg:h-[60px] bg-white lg:rounded-full lg:justify-between justify-center items-center px-6 mx-12 mt-6 drop-shadow-lg z-20`}
    >
      ...
      {showSortOption ? (
        <div className="flex flex-row ml-10 mr-3 items-center w-10/12 justify-center my-5 transition-all duration-1000 ease-in-out">
